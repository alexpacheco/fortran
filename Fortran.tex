...
%      \EndIf
  ...
  \fontsize{4}{5}{  If you are attending the Parallel Programming Workshop, complete this exercise }
...
%    \item A module is a program unit that is not executed directly, but contains data specifications and procedures that may be utilized by other program units via the use statement.
  ...
  \end{itemize}
  \framebreak
  \lstinputlisting[language={[90]Fortran},basicstyle=\fontsize{4}{5}\selectfont\ttfamily,multicols=2,firstline=1,lastline=20]{./MD/md-v3.f90}
  \vspace{-0.5cm}
  \begin{itemize}
